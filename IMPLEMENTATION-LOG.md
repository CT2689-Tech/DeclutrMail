...
| D159 | Observability stack: **Sentry + PostHog | 🟢 | #34, #49, #259, #269, #277, #370, #377, #454, #455, #471, #473, #474, #502, #498, #546, #549, #550, #551 | apps/api/src/observability/sentry-worker-observer.spec.ts |  |
...
| D245 | Unified product clarity and control contract | 🔵 | #332, #333, #335, #336, #368, #393, #394, #400, #403, #409, #438, #483, #485, #491, #492, #544 |  |  |
...
| D254 | Brand logos on sender avatars | 🔵 | #524, #528, #530, #533, #535, #537, #542 |  |  |
