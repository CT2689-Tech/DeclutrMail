...
| D158 | Hosting stack | 🔵 | #189, #385, #423, #424 |  |  |
...
| D162 | Email provider: **Resend ($20/mo, 100k emails, React-Email templates) | 🔵 | #204, #223, #310, #405, #406 |  |  |
...
| D224 | Sync gate transport schema + `useSyncStatus` contract (resolves HC-1) | 🟢 | #38, #122, #279, #287, #314, #370, #418 | apps/api/src/auth/google-oauth.controller.spec.ts |  |
