// Per-feature error boundary for `/brief` — D38 + FOUNDER-FOLLOWUPS
// 2026-06-06. Scopes a render throw to this route; tag `brief` groups
// in Sentry distinctly. Privacy (D7): `error.message` never rendered.
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          We couldn&rsquo;t open your daily brief.
        </h1>
        <p
          style={{
            fontSize: text.md,
