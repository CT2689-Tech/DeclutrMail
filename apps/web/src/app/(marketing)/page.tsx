...
const DESCRIPTION =
  'Review Gmail by sender with Keep, Archive, Unsubscribe, Later, and Delete. See the exact count and Gmail changes before anything moves, then verify outcomes in Activity.';
