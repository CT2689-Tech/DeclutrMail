...
export default function CookiePreferencesPage() {
  return (
    <LegalPageLayout title="Cookie Preferences" lastUpdated={LAST_UPDATED} toc={TOC}>
      ...
      <LegalSection id="your-choice" title="1. Your preference">
        <p>
          This is the preference the cookie banner asked for on your first visit. You can change or
      ...
      <LegalSection id="what-each-option-means" title="2. What each option means">
        <p>
          ...
          required for the service to function and are always on. Your consent preference itself is
          also stored on this device so we do not ask again.
        </p>
        <p>
