...
export const AUTO_ARCHIVE_LOW_ENGAGEMENT: AutopilotRuleDto = {
  ...
  // This preset is review-only, so it never offers day-7 promotion.
  observeWindowEndsAt: null,
  observeWindowElapsed: false,
  observePromptDismissedAt: null,
  observeDigest: { pendingTotal: 34, senders7d: 34, inboxMessagesNow: 212 },
...
export const AUTO_UNSUBSCRIBE_NOISY: AutopilotRuleDto = {
  ...
  observeWindowElapsed: false,
  observePromptDismissedAt: null,
  observeDigest: { pendingTotal: 3, senders7d: 2, inboxMessagesNow: 11 },
...
export const SCREEN_NEW_SENDERS: AutopilotRuleDto = {
  ...
  observeWindowElapsed: false,
  observePromptDismissedAt: null,
  observeDigest: { pendingTotal: 1, senders7d: 1, inboxMessagesNow: 2 },
  confidenceThreshold: null,
  scope: 'account',
  actionKind: 'later',
  actionPayload: {},
