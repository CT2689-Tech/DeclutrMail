...
/** The pill when part of a bulk failed — an alert, dismissible, above the last success. */
export const PillProblem: Story<typeof UndoTray> = {
  render: () =>
    frame(
      <UndoTray
        onViewActivity={() => {}}
        dataSource={{
          ...
          notices: [
            { id: 'end', tone: 'attention', label: 'Delete: 2 of 13 failed', onDismiss: () => {} },
          ],
        }}
      />,
    ),
