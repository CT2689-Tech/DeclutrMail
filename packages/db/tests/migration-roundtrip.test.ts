...
describe('migration round-trip', () => {
  ...
  it('all migrated tables and enums exist with expected shape', async () => {
    ...
    expect(objects).toEqual([
      ...
      'enum:autopilot_rule_scope',
      'enum:billing_cycle',
      'enum:billing_provider',
      'enum:billing_region',
      'enum:brand_domain_alias_source',
      'enum:brief_generated_by',
      'enum:cancel_source',
      'enum:cron_run_status',
      'enum:domain_icon_source',
      'enum:domain_icon_status',
      'enum:followup_status',
      'enum:gmail_category',
      'enum:gmail_unsubscribe_method',
      'enum:mailbox_data_deletion_status',
      'enum:mailbox_provider',
      'enum:mailbox_status',
      'enum:outbox_status',
      'enum:product_feedback_rating',
      'enum:product_feedback_surface',
