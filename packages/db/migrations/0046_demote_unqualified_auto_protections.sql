-- 0046_demote_unqualified_auto_protections.sql
--
...
--
-- Requires 0045 (adds 'gmail_important' to the enum) to have already
-- committed — Postgres forbids using a newly added enum value in the
-- same transaction that added it, so this cannot be the same migration.
--
