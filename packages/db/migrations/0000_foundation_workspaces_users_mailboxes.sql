...
CREATE INDEX "mailbox_accounts_workspace_id_idx" ON "mailbox_accounts" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "mailbox_accounts_user_id_idx" ON "mailbox_accounts" USING btree ("user_id");--> statement-breakpoint
...
CREATE TRIGGER mailbox_accounts_set_updated_at BEFORE UPDATE ON "mailbox_accounts" FOR EACH ROW EXECUTE FUNCTION set_updated_at();
