...
published cost and uses a conservative 4,800-unit/minute target with a
400-unit burst ceiling. Verify this project's effective quota before
increasing throughput; see `docs/ops/sync-infra-setup.md`.
