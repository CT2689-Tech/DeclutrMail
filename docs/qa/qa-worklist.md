...
| 🟡  | QA-delete-20260829-02 | P2  | The Senders Delete confirm modal's title ("Delete email from 1 sender") never says Trash, unlike Triage's equivalent header                                                                                                                        | In review — round 1 clean                          |     |
| 🟡  | QA-delete-20260829-03 | P2  | Empty-window notice states an age in days ("not older than 6 days") beside a control labelled in months ("6 months+")                                                                                                                              | In review — round 1 clean                          |     |
...
| 🟡  | QA-delete-20260829-05 | P3  | Senders receipt strip doesn't observe an undo performed via the global Undo tray and keeps asserting stale "Moved to Gmail Trash" state (all verbs, not Delete-specific)                                                                           | In review — round 1 found 2, fixed in `4dab8f68`   |     |
...
| 🟡  | QA-delete-20260829-08 | P3  | A zero-match Delete preview's header still reads as an active move ("Move inbox email from X to Gmail Trash" above a "0 matching emails" body)                                                                                                     | In review — round 1 clean                          |     |
| 🟡  | QA-delete-20260829-09 | P3  | Mail-location sentence mixes a singular subject ("this email") with a four-digit population and drops the unit noun on one side of the split                                                                                                       | In review — round 1 found 1, fixed in `4dab8f68`   |     |
