...
| 🟡  | QA-billing-20260901-07 | P2  | Updating your payment method mints a permanent $0/"Due"/no-document Paddle transaction the adapter can't distinguish from a real unpaid invoice; it sorts to the top of the list forever, and the invoice list has no column headers                         | `PR #704` — round 3 CLOSED (`6050ec1a`)                                                                                                                      | #704 |
...
change). Every row is clean. Full findings and disposition:
`docs/qa/launch-qa.md`'s "Fix phase — 2026-09-01, PR #704".
